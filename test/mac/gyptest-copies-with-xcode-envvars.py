...
if sys.platform == 'darwin':
  ...
  contents_path = f'{wrapper_name}Contents/'
  out_path = test.built_file_path('file0', chdir='copies-with-xcode-envvars')
  test.must_contain(out_path, 'file0 contents\n')
  out_path = test.built_file_path(f'{wrapper_name}file1',
                                  chdir='copies-with-xcode-envvars')
  test.must_contain(out_path, 'file1 contents\n')
  out_path = test.built_file_path(f'{contents_path}MacOS/file2',
                                  chdir='copies-with-xcode-envvars')
  test.must_contain(out_path, 'file2 contents\n')
  out_path = test.built_file_path(f'{contents_path}Resources/file3',
                                  chdir='copies-with-xcode-envvars')
  test.must_contain(out_path, 'file3 contents\n')
  out_path = test.built_file_path(
      f'{contents_path}Resources/testimages/file4',
      chdir='copies-with-xcode-envvars',
  )
  test.must_contain(out_path, 'file4 contents\n')
  out_path = test.built_file_path(f'{contents_path}Resources/Java/file5',
                                  chdir='copies-with-xcode-envvars')
  test.must_contain(out_path, 'file5 contents\n')
  out_path = test.built_file_path(f'{contents_path}Frameworks/file6',
                                  chdir='copies-with-xcode-envvars')
  test.must_contain(out_path, 'file6 contents\n')
  out_path = test.built_file_path(f'{contents_path}Frameworks/file7',
                                  chdir='copies-with-xcode-envvars')
  test.must_contain(out_path, 'file7 contents\n')
  out_path = test.built_file_path(
      f'{contents_path}SharedFrameworks/file8',
      chdir='copies-with-xcode-envvars',
  )
  test.must_contain(out_path, 'file8 contents\n')
  out_path = test.built_file_path(f'{contents_path}SharedSupport/file9',
                                  chdir='copies-with-xcode-envvars')
  test.must_contain(out_path, 'file9 contents\n')
  out_path = test.built_file_path(f'{contents_path}PlugIns/file10',
                                  chdir='copies-with-xcode-envvars')
  test.must_contain(out_path, 'file10 contents\n')
  out_path = test.built_file_path(f'{contents_path}XPCServices/file11',
                                  chdir='copies-with-xcode-envvars')
