...
if sys.platform == 'darwin':
  ...
  out_path = test.built_file_path(f'{contents_path}file2',
                                  chdir='copies-with-xcode-envvars')
  test.must_contain(out_path, 'file2 contents\n')
  out_path = test.built_file_path(f'{contents_path}file3',
                                  chdir='copies-with-xcode-envvars')
  test.must_contain(out_path, 'file3 contents\n')
  out_path = test.built_file_path(f'{contents_path}testimages/file4',
                                  chdir='copies-with-xcode-envvars')
  test.must_contain(out_path, 'file4 contents\n')
  out_path = test.built_file_path(f'{contents_path}Java/file5',
                                  chdir='copies-with-xcode-envvars')
